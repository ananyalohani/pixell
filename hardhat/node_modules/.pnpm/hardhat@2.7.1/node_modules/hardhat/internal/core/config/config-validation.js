...
const HardhatNetworkConfig = t.type(Object.assign(Object.assign({}, commonNetworkConfigFields), { hardfork: (0, io_ts_1.optional)(t.keyof((0, lang_1.fromEntries)(constants_1.HARDHAT_NETWORK_SUPPORTED_HARDFORKS.map((hf) => [hf, null])))), accounts: (0, io_ts_1.optional)(t.union([t.array(HardhatNetworkAccount), HardhatNetworkHDAccountsConfig])), blockGasLimit: (0, io_ts_1.optional)(t.number), minGasPrice: (0, io_ts_1.optional)(t.union([t.number, t.string])), throwOnTransactionFailures: (0, io_ts_1.optional)(t.boolean), throwOnCallFailures: (0, io_ts_1.optional)(t.boolean), allowUnlimitedContractSize: (0, io_ts_1.optional)(t.boolean), initialDate: (0, io_ts_1.optional)(t.string), loggingEnabled: (0, io_ts_1.optional)(t.boolean), forking: (0, io_ts_1.optional)(HardhatNetworkForkingConfig), mining: (0, io_ts_1.optional)(HardhatNetworkMiningConfig), coinbase: (0, io_ts_1.optional)(exports.address) }));
